...
myligand = 'MyBindingSite.pdb'
myligandmol2 = 'MyLigand.mol2'
myprotein = 'MyProtein.pdb'
estimate_enthalpy = 1
...
os.system("source /home/phzd/test/amber16/amber.sh")
...
bashline1_0 = "/opt/gmx2016.4/bin/gmx pdb2gmx -f protein.pdb -o proteinH.pdb -p protein.top -ignh <<EOF\n6\n1\nEOF\n"
...
if withligand == 1:	
  ...
  #generate ligand position restraint file
	bashline2b = "echo '0' |/opt/gmx2016.4/bin/gmx genrestr -f ligand_GMX.gro -o posre_ligand.itp"
  ...
  # fuse ligand and protein files
	...
	os.system("/opt/gmx2016.4/bin/gmx editconf -f ligand_GMX.gro -o ligand_GMX.pdb")
...
if not os.path.exists("protein.gro"):
	bashline2c = "/opt/gmx2016.4/bin/gmx editconf -bt cubic -f proteinH.pdb -o protein.gro -c -d 1.0"
...
#bashline2c_1 = "/opt/gmx2016.4/bin/gmx genbox -cp protein.gro -cs spc216.gro -o prot_4ion.gro -p protein.top" 
### genbox:This tool has been split to gmx solvate and gmx insert-molecules.
if not os.path.exists("prot_4ion.gro"):
	bashline2c_1 = "/opt/gmx2016.4/bin/gmx solvate -cp protein.gro -o prot_4ion.gro -p protein.top"
...
if not os.path.exists("prot_4ion.tpr"):
	bashline2c_2 = "/opt/gmx2016.4/bin/gmx grompp -f /home/phzd/g09E/WATsite_GC/mdp_files/posre/em.mdp -c prot_4ion.gro -p protein.top -o prot_4ion.tpr -maxwarn 50"
...
if not os.path.exists("prot_em.gro"):
	bashline2c_3 = "echo 'SOL' | /opt/gmx2016.4/bin/gmx genion -s prot_4ion.tpr -o prot_em.gro -p protein.top -pname NA -nname CL -neutral"
...
if not os.path.exists("prot_min.trr"):
	bashline3_0 = "/opt/gmx2016.4/bin/gmx grompp -f /home/phzd/g09E/WATsite_GC/mdp_files/posre/em.mdp -c prot_em.gro -p protein.top -o prot_min.tpr -maxwarn 50"
	bashline3_1 = "/opt/gmx2016.4/bin/gmx mdrun -v -s prot_min.tpr -o prot_min.trr -c prot_pr.gro -g min.log -e min.edr"
	bashline3_2 = "rm \#*"
...
if os.path.exists('min.log') and (not os.path.exists('prot_pr.gro')):
	...
	if match:    ## using one cpu only
		os.system("/opt/gmx2016.4/bin/gmx mdrun -v -s prot_min.tpr -o prot_min.trr -c prot_pr.gro -g min.log -e min.edr -nt 1")
	os.system("rm \#*")
...
bashline3b = "/opt/gmx2016.4/bin/gmx grompp -f /home/phzd/g09E/WATsite_GC/mdp_files/posre/pr.mdp -c prot_pr.gro -p protein.top -o prot_pr.tpr -maxwarn 50"
bashline3b_1 = "/opt/gmx2016.4/bin/gmx mdrun -v -s prot_pr.tpr -o prot_pr.trr -c prot_equ.gro -g pr.log -e pr.edr"
os.system(bashline3b + " && " + bashline3b_1 + " && " + "rm \#*")


print('now beginning equ of md ')
bashline3b_2 = "/opt/gmx2016.4/bin/gmx grompp -f /home/phzd/g09E/WATsite_GC/mdp_files/posre/equ.mdp -c prot_equ.gro -p protein.top -o prot_equ.tpr -maxwarn 50"
bashline3b_3 = "/opt/gmx2016.4/bin/gmx mdrun -v -s prot_equ.tpr -o prot_equ.trr -c prot_md.gro -g equ.log -e equ.edr"
os.system(bashline3b_2 + " && " + bashline3b_3 + " && " + "rm \#*")

bashline3b_4 = "/opt/gmx2016.4/bin/gmx grompp -f /home/phzd/g09E/WATsite_GC/mdp_files/posre/md_new.mdp -c prot_md.gro -p protein.top -o prot_md.tpr -maxwarn 50"
os.system(bashline3b_4)

if not os.path.exists('prot_md.tpr'):
	bashline3b_4 = "/opt/gmx2016.4/bin/gmx grompp -f /home/phzd/g09E/WATsite_GC/mdp_files/posre/md.mdp -c prot_md.gro -p protein.top -o prot_md.tpr -maxwarn 50"
	os.system(bashline3b_4)

bashline3b_5 = "/opt/gmx2016.4/bin/gmx mdrun -v -s prot_md.tpr -o prot_md.trr -c prot_fin.gro -g md.log -e md.edr"
